//Definindo a string original que contém a frase "Meu nome é Caio!".
let string = "Meu nome é Caio!";
//Variável quantasVogaisTem, que será usada para contar o número de vogais na string. e qualVogal, que será usada para armazenar as vogais encontradas.
...
//Forma "NFD" (Normalização de Decomposição Canônica) para decompor os caracteres Unicode(é um esquema de codificação de caracteres de comprimento fixo que inclui caracteres de quase todas as línguas vivas do mundo) em sua forma básica e seus diacríticos (acento, cedilha etc.). Isso significa que caracteres acentuados serão decompostos em uma combinação do caractere base e o diacrítico representando o acento. 
...
// A regex é uma combinacão dos códigos dos acentos possíveis.
